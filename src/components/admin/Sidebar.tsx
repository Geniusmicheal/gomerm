...
import { gomermLogOut } from '@utils/Auth';
import React from 'react'
import { NavLink } from 'react-router-dom';

const Sidebar:  React.FC<{ openSideMenu:boolean }>   = ({openSideMenu}) => {
   const { authDispatch } = useAppContext();
   
   return <aside className={openSideMenu?'max-w-[165px]':''}>
      <ul>
         <li>
         ...
         <li>
            <NavLink  className={({ isActive }) => isActive ? "active" : ""} to="/dashboard/product/add" end>
         ...
         <li>
            <NavLink  className={({ isActive }) => isActive ? "active" : ""} to="/dashboard/product" end>
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
         ...
         <li onClick={()=>gomermLogOut(authDispatch)}>
            <a>
